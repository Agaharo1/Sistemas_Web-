...
import { formularioPuntoRecogida,formularioEnvioProducto,envioProducto,mostrarPuntoRecogida} from './controllers.js';
...
envioRouter.post('/formPuntoRecogida/:id', autenticado('/usuarios/login'), mostrarPuntoRecogida);
